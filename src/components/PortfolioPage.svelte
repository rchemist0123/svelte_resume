...
<div class="mt-60 max-w-xl border mx-auto" id="section-3">
  ...
  <div class="mx-auto">
    <div class="grid md:grid-cols-2 ">
      <div class="p-6">
        <img class="w-64 mx-auto object-cover rounded-xl " src="/src/assets/laptop.jpg" alt="Project" />
      </div>
      <div class="p-6 mx-auto border">
        <p class="font-extrabold">ICU NOAF (MIMIC-IV)</p>
        <p class="text-xs w-48 my-3 text-slate-800">Lorem, ipsum dolor sit amet consectetur adipisicing elit. Quas impedit, odit obcaecati fuga quisquam illum atque quam inventore debitis a dolor sint ad numquam unde recusandae nobis. Itaque, ipsa iure?</p>
        ...
        <div class="">
          ...
          <a href="https://yeonhoon.shinyapps.io/KHC_HRA2/" target="_blank" class="group text-slate-700 hover:text-primary-600 dark:text-white text-xs font-semibold my-auto">
            Live Demo
  ...
  <div class="mx-auto mt-60">
    <div class="grid md:grid-cols-2">
      ...
      <div class="p-6">
        <img class="h-48 mx-auto object-cover rounded-xl md:w-full" src="/src/assets/laptop.jpg" alt="Project" />
      </div>
    </div>
  </div>
