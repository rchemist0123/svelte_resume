<section class="pt-40 p-10 md:p-20 dark:bg-slate-800" id="section-4"> 
    <div class="mx-auto flex flex-col items-center">
      ...
      <p class="font-bold md:text-left text-md text-black my-3 dark:text-white">연락은 언제든 대환영입니다!👇🏻</p>
    </div>
    <div class="flex flex-col gap-y-3 md:flex-row md:space-x-3 justify-center">
      <!-- <div class="grid space-y-3 md:grid-cols-2 md:space-x-3 items-center"> -->
